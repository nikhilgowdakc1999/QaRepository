...
public class Assignment3TrailActime {
	...
	private static void Adminlogin1(String User,String pwd)
	{
		try
		{
	...
	@Test(priority=3,dataProvider = "LoginData")
	private static void Adminlogin2(String User,String pwd)
	{
		try
		{
			oBrowser.findElement(By.id("username")).sendKeys(User);
	...
	@Test(priority=3,dataProvider = "LoginData")
	private static void Adminlogin3(String User,String pwd)
	{
		try
		{
			oBrowser.findElement(By.id("username")).sendKeys(User);
