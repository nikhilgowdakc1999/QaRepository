package com.sgtesting.xpathallcases;
...
private static void navigate()
{
	try
	{
		oBrowser.get("file:///E:/Niki/Sg%20notes/xpath_xpathaxes_samplehtmlfiles/SampleXPath.html");
		Thread.sleep(5000);
	}catch(Exception e)
	{
		e.printStackTrace();
...
private static void relativeXPathUsingTagNameWithAttributeName()
{
	try
	{
		...
		List<WebElement> olinks=oBrowser.findElements(By.xpath("//a[@href][1]"));
		int linkscount=olinks.size();
	WebElement s=olinks.get(0);
	String f=s.getText();
