...
# Date Created 
@Nik @sam
Feature: Login,Create Customer,Create Project,Modify Project,Delete project,Delete customer and Logout functionality
Description this features validates Login,Create customer,Create Project,Modify Project,Delete project,Delete customer and Logout functionalities
...
Scenario: Verify the Modify Project functionality
