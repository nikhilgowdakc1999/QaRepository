...
Feature: Login,Create user,Delete user and Logout functionality
Description this features validates Login,Create user,Delete user and Logout functionalities
